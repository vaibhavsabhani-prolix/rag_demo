...
assert 0.0 <= MIN_RESULT_SCORE <= 1.0, "MIN_RESULT_SCORE must be between 0.0 and 1.0"
assert 0.0 <= REQUEST_SATISFACTION_WEIGHT <= 1.0, "REQUEST_SATISFACTION_WEIGHT must be between 0.0 and 1.0"
assert (
    0.0
